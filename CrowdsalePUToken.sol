...
contract CrowdsalePUToken is PUToken {
    uint256 public constant nativeDecimals = 18;

    /// @notice 100 million PUT tokens for sale
    ...
    /// @notice Creates new CrowdsalePUToken contract
    /// @param _fundingStartBlock The starting block of crowdsale
    /// @param _fundingEndBlock The ending block of crowdsale
    /// @param _initialExchangeRate The exchange rate of Ether to PUT
    /// @param _presaleAmount The amount of PUT that will be available for presale
    function CrowdsalePUToken(
        ...
        public
    {
        ...
        // Converted to lowest denomination of PUT
    ...
    /// @notice Shows the amount of PUT the user will receive for amount of exchanged wei
    /// @param _weiAmount Exchanged wei amount to convert
    /// @param _exchangeRate Number of PUT per exchange token
    /// @param _nativeDecimals Number of decimals of the token being exchange for PUT
    /// @param _decimals Number of decimals of PUT token
    /// @return The amount of PUT that will be received
